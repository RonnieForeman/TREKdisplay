    ...
    _floorplanOpen(false)
{
    ...
    // ******************** S.Q.U.A.D. coding ********************
    QObject::connect(ui->anchorSelectComboBox, SIGNAL(currentIndexChanged(int)), this, SLOT(anchorSelectComboBoxChanged(int)));
    QObject::connect(ui->dropPenPushButton, SIGNAL(clicked(bool)), this, SLOT(dropPenPushButtonPressed()));
    // ********************* S.Q.U.A.D. end **********************
...
// ******************** S.Q.U.A.D. coding ********************
void ViewSettingsWidget::anchorSelectComboBoxChanged(int anchor)
{
    m_iAnchor = anchor;
    this->dropPenPushButtonPressed();
}

void ViewSettingsWidget::dropPenPushButtonPressed()
{
...
void ViewSettingsWidget::viewUpdateAnchorXY()
{
    xPosition = tool->getXPosition();
    yPosition = tool->getYPosition();

    RTLSDisplay = RTLSDisplayApplication::instance();
